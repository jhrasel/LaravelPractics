    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('home') }}">
                ...
                <img src="{{ asset('backend_asset') }}/images/brand/logo-1.png" class="header-brand-img toggle-logo"
                    alt="logo">
                <img src="{{ asset('backend_asset') }}/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
